...
/*   Updated: 2025/09/22 16:00:24 by vinguyen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static	void	child_pipe_heredoc(t_pipe_simple *pipex, t_cmd *cmds, char **args, char **env[]);
...
static	void	parent_pipe_heredoc(t_pipe_simple *pipex, t_cmd *cmds)
{
    ...
    write(pipex->pipefd[1], cmds->here_doc_cont, ft_strlen(cmds->here_doc_cont));
